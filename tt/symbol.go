...
//
// Each symbol has a name, type and parent scope. The latter is determined by the place of origin (definition)
// of the symbol.
//
...
type Symbol struct {
	// Source position of symbol origin (where this symbol was defined)
	Pos source.Pos
	...
	// unit is defined, can use this symbol in their code.
	Public bool
}
